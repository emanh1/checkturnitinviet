    ...
    <div class="space-y-6">
      ...
      <div class="grid gap-6 md:grid-cols-3">
        <UCard>
          ...
          <template #footer>
            <UButton color="primary" block :loading="isLoading" @click="buyCredits(10)">Mua ngay</UButton>
          </template>
        </UCard>
        ...
        <UCard>
          ...
          <template #footer>
            <UButton color="primary" block :loading="isLoading" @click="buyCredits(50)">Mua ngay</UButton>
          </template>
        </UCard>
        ...
        <UCard>
          ...
          <template #footer>
            <UButton color="primary" block :loading="isLoading" @click="buyCredits(100)">Mua ngay</UButton>
          </template>
        </UCard>
      </div>
      ...
      <UCard>
        ...
        <div class="text-center">
          <div class="text-4xl font-bold text-slate-900 dark:text-white">{{ profile?.credits ?? 0 }}</div>
          <p class="mt-2 text-sm text-slate-600 dark:text-slate-300">credits khả dụng</p>
        </div>
      </UCard>
